...
namespace BangumiProject.Process.AnimeFilterB
{
        ...
        public AnimeFilterByAnimeType(int AnimeType)
        {
            switch (AnimeType)
            {
                case -1:
                    ...
                    break;
                case 0:
                    this.AnimeType = Areas.Bangumi.Models.AnimeType.TVAnime;
                    break;
                case 1:
                    this.AnimeType = Areas.Bangumi.Models.AnimeType.OVA;
                    break;
                case 2:
                    this.AnimeType = Areas.Bangumi.Models.AnimeType.MovieAnime;
                    break;
                case 3:
                    this.AnimeType = Areas.Bangumi.Models.AnimeType.Other;
                    break;
                default:
                    All = true;
                    break;
