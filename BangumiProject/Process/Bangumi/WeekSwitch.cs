...
namespace BangumiProject.Process.Bangumi
{
    public class WeekSwitch
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<List<UserAnimeInfo>> SwitchAnimeByStats(List<UserAnimeInfo> animes)
        {
            List<UserAnimeInfo> AnimeEnd = new List<UserAnimeInfo>();//看完的
            List<UserAnimeInfo> AnimeStart = new List<UserAnimeInfo>();//已经开始看的
            List<UserAnimeInfo> AnimeSubed = new List<UserAnimeInfo>();//订阅完还没开始看的
            ...
            return new List<List<UserAnimeInfo>> { AnimeSubed, AnimeStart, AnimeEnd };
        }
